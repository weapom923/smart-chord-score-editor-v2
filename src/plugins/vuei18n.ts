...
const messageJa = {
  ...
  seekToTail: '末尾へ',
  volume: '音量',
  clearLoopRange: 'ループ区間を解除',
  enableAutoScroll: '自動スクロール有効化',
  disableAutoScroll: '自動スクロール無効化',
  audioPlaybackConfig: '音声再生設定',
  setBarTimeOffset: '小節時刻オフセット設定',
  chordText: 'コードテキスト',
  section: 'セクション',
  sectionName: 'セクション名',
  clefSign: '音部記号',
  ...
  normal: '通常',
  rhythm: 'リズム',
  barTimeOffsetInSec: '小節時刻オフセット(秒)',
  beatPerMinutes: 'BPM',
  unitBeatValue: '基準音価',
  autoSelectBarByPlayTime: '小節自動選択',
  bar: '小節',
...
const messageEn: Messages = {
  ...
  volume: 'Volume',
  clearLoopRange: 'Clear loop range',
  enableAutoScroll: 'Enable auto scroll',
  disableAutoScroll: 'Disable auto scroll',
  audioPlaybackConfig: 'Audio playback configuration',
  setBarTimeOffset: 'Set bar time offset',
  ...
  clefSignBass: 'Bass',
  numPagesPerRow: 'Number of pages per a row',
  ...
  chordTextColor: 'Chord text color',
  ...
  normal: 'Normal',
  rhythm: 'Rhythm',
  barTimeOffsetInSec: 'Bar time offset(sec)',
  beatPerMinutes: 'BPM',
  unitBeatValue: 'Unit beat value',
  autoSelectBarByPlayTime: 'Auto select bar by play time',
  bar: 'Bar',
